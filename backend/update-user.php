...
<body class="nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        if (isset($_POST['edit-user'])) {
            ...
            $url = "http://localhost/Climbin-main/backend/update-user.php?user_id=" . $user_id;
            header("Location: {$url}");
        }
            ...
            <main>
                ...
                <div class="container-fluid mt-n10">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="update-user.php?user_id=<?php echo $_GET['user_id']; ?>" method="POST" enctype="multipart/form-data">
                                <?php
                                if (isset($err_email)) {
