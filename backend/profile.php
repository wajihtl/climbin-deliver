                            ...
                            <div class="card-body">
                                <form action="profile.php" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <input name="user-name" value="<?php echo $user_name; ?>" class="form-control" id="user-name" type="text" placeholder="nom..." />
                                    </div>
                                    <div class="form-group">
                                        <label for="user-email">E-mail de l'utilisateur:</label>
                                        <input name="user-email" value="<?php echo $user_email; ?>" class="form-control" id="user-email" type="email" placeholder="Email..." />
                                    </div>
                                    <div class="form-group">
                                        <div class="form-group">
                                        <label for="post-title">Choisir photo:</label>
                                    ...
                                    <button name="submit" class="btn btn-primary mr-2 my-1" type="submit">Mettre à jour </button>
                                </form>
                            </div>
                        </div>
                    </div>
