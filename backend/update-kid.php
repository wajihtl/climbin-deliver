    ...
    <div id="layoutSidenav_content">
        <main>
            ...
            if (isset($_POST['update'])) {
                ...
                $sql = "UPDATE kid SET  Price='$price',Title='$Title',description='$description' WHERE id='$id' ";
            ...
            if (isset($_POST['edit-user'])) {
                $id = $_POST['id'];
                $url = "http://localhost/Climbin-main/backend/update-kid.php?id=" . $id;
                header("Location: {$url}");
            }
            ...
            <div class="container-fluid mt-n10">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="update-kid.php?id=<?php echo $_GET['id']; ?>" method="POST"
                              enctype="multipart/form-data">


                            <div class="form-group">
                                <label for="adresse"> price:</label>
                                <input value="<?php echo $price; ?>" name="price" class="form-control"
                                       id="restaurant-adresse" type="text" placeholder="price..."/>
                            </div>
                            <div class="form-group">
