        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="bs-text">
                    ...
                    <source src="./video/adults-updated.mp4" type="video/mp4"></video>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="gallery-section spad-1">
        <div class="gallery">
            <div class="grid-sizer"></div>
                    ...
                    $stmt = $pdo->prepare($sql);
                    $stmt->execute();
                    while ($gallery = $stmt->fetch(PDO::FETCH_ASSOC)) {

                        $id = $gallery['id'];
                        $Picture = $gallery['Picture'];

                        ?>
                <div class="gs-item set-bg" data-setbg="img/gallery/<?php echo $Picture; ?>">
                    <a href="img/gallery/<?php echo $Picture; ?>" class="thumb-icon image-popup"></a>
                </div>
                    <?php }
                    ?>
        </div>
